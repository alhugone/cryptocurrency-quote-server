...
namespace CoinbasePro
{
    public class CoinbaseProClient : ICoinbaseProClient
    {
        ...
        public CoinbaseProClient(
            ...
            : this(null, new HttpClient(), false, webSocketFeed)
        {
        }
        ...
        public CoinbaseProClient(
            ...
            bool sandBox = false,
            IWebSocketFeed webSocketFeed=null)
        {
            var clock = new Clock();
            var httpRequestMessageService = new HttpRequestMessageService(authenticator, clock, sandBox);
            var createWebSocketFeed = (Func<IWebSocketFeed>)(() =>webSocketFeed?? new WebSocketFeed(sandBox));
